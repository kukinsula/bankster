...
export function PrettySince(start: [number, number], options: any = { long: true }): string {
  return ms(Since(start) / 1e6, options);
}

export function PrettyDuration(duration: Duration, options: any = { long: true }): string {
